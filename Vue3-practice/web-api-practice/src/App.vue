<template>
    <GetIssues :token = "token"></GetIssues>
    <PostIssues :token = "token"></PostIssues>
    <PatchIssues :token = "token"></PatchIssues>
    <GetAndDeleteComment :token = "token"></GetAndDeleteComment>
    <CommitComment :token = "token"></CommitComment>
</template>
